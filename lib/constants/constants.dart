...
Color scaffoldBackgroundColor = Color.fromARGB(255, 255, 109, 109);
Gradient grad = LinearGradient(
    begin: Alignment.topLeft,
    end: Alignment.bottomRight,
    colors: [Color(0xFFF568AA), Color(0xFFB923F5)]);

Color cardColor = Color.fromARGB(127, 145, 162, 238);
Color cardColor2 = Color.fromARGB(255, 248, 132, 132);
